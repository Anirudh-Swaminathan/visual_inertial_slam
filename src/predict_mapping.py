...
# Created by anicodebreaker on March 11, 2020
...
if __name__ == '__main__':
    ...
    save_base = "./outputs/predict_mapping/d0027/try_002/"
    ani_imu = IMU()
    ...
    for ti in range(1, t.shape[1]):
        ...
        if ti % 100 == 0 or ti == 1:
            ...
            visualize_trajectory_2d(world_T_imu, dead_means=dead_map[:, :land_means.shape[1]], landmarks=land_means,
                                    path_name="p_mp_0027", show_ori=True,
    ...
    # assert (world_T_imu.shape[2] == t.shape[1])
    land_means = lms.get_obs_means()
    visualize_trajectory_2d(world_T_imu, dead_means=dead_map, landmarks=land_means, path_name="p_mp_0027", show_ori=True,
